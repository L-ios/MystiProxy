...
use mystiproxy::config::{
    ...
    JsonBodyConfig, LocationConfig, MatchMode, MystiConfig, ProviderType, ProxyType,
    RequestConfig, ResponseConfig, UriConfig,
};
...
fn test_e2e_config_serialization_round_trip() {
    ...
    let parsed: EngineConfig = serde_yaml::from_str(&yaml)
...
fn test_e2e_all_provider_types_round_trip() {
    for provider in [ProviderType::Static, ProviderType::Mock, ProviderType::Proxy] {
